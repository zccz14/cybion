...
OpenAI-LB account model. Optional completion and failure notifications use a user-owned
Linkit Bot and that same subject's private conversation. Notification setup and
delivery are independent of model inference and OpenAI-LB refresh; the
configuration page exposes test delivery and the latest receipt or failure.
