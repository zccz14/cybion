...
import { Bot, ChevronRight, Files, KeyRound, LoaderCircle, Network, Plus, Send, Server, Settings2, TerminalSquare } from 'lucide-react';
...
const words = {
  en: {
    console: 'Console', machines: 'Machines', files: 'Files', signOut: 'Sign out', activeMachine: 'ACTIVE MACHINE', online: 'Online',
    ...
    language: '中文', theme: 'Dark', settings: 'Display settings', loadingMachine: 'Loading machine', connecting: 'Connecting…',
  },
  zh: {
    console: '控制台', machines: '机器', files: '文件', signOut: '退出登录', activeMachine: '当前机器', online: '在线',
    ...
    language: 'EN', theme: '亮色', settings: '显示设置', loadingMachine: '正在载入机器', connecting: '正在连接…',
  },
} as const;
